                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  >
                    <SelectTrigger className="w-48">
                      <SelectValue placeholder={t('receipts.filters.status')} />
                    </SelectTrigger>
                    <SelectContent
                      onCloseAutoFocus={(e) => {
                        e.preventDefault();
                  ...
                  >
                    <SelectTrigger className="w-36">
                      <SelectValue placeholder={t('receipts.sort.direction')} />
                    </SelectTrigger>
                    <SelectContent
                      onCloseAutoFocus={(e) => {
                        e.preventDefault();
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 text-sm">
                  <thead className="bg-gray-50 text-left text-xs font-semibold uppercase text-muted-foreground">
                    <tr>
                      <th className="px-4 py-3">{t('receipts.columns.id')}</th>
                    ...
                    {filtered.map((receipt) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            {receipt.feedbackResult?.pointsValue !==
                              undefined &&
